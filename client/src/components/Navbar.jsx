...
const Navbar = () => {
    ...
    return (
        <div className='w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0'>
            ...
            <img src={assets.logo_net} alt="" className='w-28 sm:w-32' />
            {userData ? <div className='flex justify-center items-center w-8 h-8 rounded-full bg-red-600 text-white relative group'>
